    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-body">
            <form method="post" class="row g-3">
                ...
                <div class="col-md-4">
                    <button type="submit" name="add_remark" class="btn btn-success w-100">Add Remark</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <table class="table table-bordered table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="?delete_id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this remark?')">Delete</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                    ...
                    <tr>
                        <td colspan="4" class="text-center text-muted">No remarks found.</td>
                    </tr>
                    <?php endif; ?>
                </tbody>
            </table>
